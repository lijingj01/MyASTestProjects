...
import example.lijingj.com.myapp01.R;
...
public class NewsListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public NewsListAdapter(BaseActionBarActivity mContext, List<ProjectPlanEntity> mDataList) {
    ...
    public int getItemViewType(int position) {
        ...
        if (position == 0)
            return GROUP_ITEM;
        //默认都显示时间
//        String currentDate = mDataList.get(position).getBeginDate();
...
//        return isDifferent ? GROUP_ITEM : NORMAL_ITEM;
    ...
    void bindNormalItem(ProjectPlanEntity entity, TextView newsTitle, ImageView newsIcon) {
...
//        }
        newsTitle.setText(Html.escapeHtml(entity.getPlanTitle()));
    }

    void bindGroupItem(ProjectPlanEntity entity, GroupItemHolder holder) {
        bindNormalItem(entity, holder.newsTitle, holder.newsIcon);
